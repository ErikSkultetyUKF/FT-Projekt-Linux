<template>
  <v-container>
    ...
    <div>
      <img
        :src="'/img/distributions/' + distro.img"
        :alt="distro.imgDesc"
        class="img-distro"
      >
    ...
    <div class="mt-0">
      ...
      <a
        href="https://www.atatus.com/blog/top-10-linux-distros/"
        target="_blank"
      >
        https://www.atatus.com/blog/top-10-linux-distros/
      </a>
    </div>
...
<script>
import distroData from "@/data/distributions.json"
export default {
  data() {
    return {
      distro: distroData.distros.find(
          distro => distro.slug === this.slug
      )
    }
  },
  props: {
